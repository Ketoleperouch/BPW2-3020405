...
namespace UnityStandardAssets.Cameras
{
    public class ProtectCameraFromWallClip : MonoBehaviour
    {
        ...
        private float m_XOffset;                  // a possible offset on the x axis of the camera transform
        ...
        private void Start()
        {
            ...
            m_XOffset = m_Cam.transform.localPosition.x;
        ...
        private void LateUpdate()
        {
            ...
            if (hitSomething && visualiseInEditor)
            {
            ...
            m_Cam.localPosition = -Vector3.forward*m_CurrentDist + Vector3.right * m_XOffset;
        }
